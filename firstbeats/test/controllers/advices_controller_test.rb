...
class AdvicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advice" do
    assert_difference('Advice.count') do
      post advices_url, params: { advice: { activate_advice: @advice.activate_advice, creation: @advice.creation, description: @advice.description, theme_id: @advice.theme_id, user: @advice.user, validate_advice: @advice.validate_advice } }
    end
  ...
  test "should update advice" do
    patch advice_url(@advice), params: { advice: { activate_advice: @advice.activate_advice, creation: @advice.creation, description: @advice.description, theme_id: @advice.theme_id, user: @advice.user, validate_advice: @advice.validate_advice } }
